    ...
    <div className="min-h-screen bg-black text-[var(--limestone)] font-sans selection:bg-[var(--brass)] selection:text-black">
      ...
      <section id="products" className="py-24 px-8 md:px-20 bg-[var(--charcoal)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { name: 'Obsidian Brick', cat: 'Face Brick', img: 'https://images.unsplash.com/photo-1564013434775-f71db0030976?auto=format&fit=crop&w=600&q=80' },
            { name: 'Algonquin Granite', cat: 'Natural Stone', img: '/AlgonquinGranite_sample_1_LG.jpg', rotate: true },
            { name: 'Aged Ross Stone', cat: 'Veneer', img: 'https://images.unsplash.com/photo-1541123437800-1bb1317badc2?auto=format&fit=crop&w=600&q=80' },
            { name: 'Charcoal Block', cat: 'Architectural Block', img: 'https://images.unsplash.com/photo-1589939705384-5185137a7f0f?auto=format&fit=crop&w=600&q=80' },
          ].map((p, i) => (
            <div key={i} className="group cursor-pointer">
              <div className="aspect-[4/5] bg-[var(--charcoal)] mb-4 relative overflow-hidden border border-white/5 hover:border-[var(--brass)]/30 transition-colors duration-300">
                <img src={p.img} alt={p.name} className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" style={p.rotate ? { transform: 'rotate(90deg) scale(1.4)', transformOrigin: 'center' } : {}} />
      ...
      <section className="py-24 px-8 md:px-20 bg-[var(--charcoal)] text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            { title: 'Exterior Cladding', img: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=800&q=80' },
            { title: 'Driveways', img: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?auto=format&fit=crop&w=800&q=80' },
            { title: 'Patios & Walkways', img: 'https://images.unsplash.com/photo-1600210492493-0946911123ea?auto=format&fit=crop&w=800&q=80' },
            { title: 'Retaining Walls', img: 'https://images.unsplash.com/photo-1513694203232-719a280e022f?auto=format&fit=crop&w=800&q=80' },
            { title: 'Pool Decks', img: 'https://images.unsplash.com/photo-1575429198097-0dcf0da09de0?auto=format&fit=crop&w=800&q=80' },
            { title: 'Steps & Caps', img: 'https://images.unsplash.com/photo-1567930015852-551e32e6c4f4?auto=format&fit=crop&w=800&q=80' },
          ].map((s, i) => (
            <div key={i} className="group relative overflow-hidden cursor-pointer aspect-square">
      ...
      <section id="gallery" className="py-24 px-8 md:px-20 bg-black">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
          <div className="lg:col-span-3 aspect-square lg:aspect-auto relative group overflow-hidden border border-white/5 min-h-64">
            <img src="https://images.unsplash.com/photo-1600047509807-ba8f99d2cdde?auto=format&fit=crop&w=1200&q=80" alt="The Muskoka Residence" className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
          ...
          <div className="lg:col-span-2 grid grid-rows-2 gap-4">
            {[
              { title: 'Urban Commercial Plaza', img: 'https://images.unsplash.com/photo-1486325212027-8081e485255e?auto=format&fit=crop&w=800&q=80' },
              { title: 'Heritage Restoration', img: 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&w=800&q=80' },
            ].map((t, i) => (
              <div key={i} className="border border-white/5 relative group cursor-pointer overflow-hidden text-white flex items-end p-6 min-h-32">
