          ...
          {[
            {
              name: "Obsidian Brick",
              cat: "Face Brick",
              img: "https://images.unsplash.com/photo-1564013434775-f71db0030976?auto=format&fit=crop&w=600&q=80",
            },
            {
      ...
      <section className="py-24 px-8 md:px-20 bg-[var(--charcoal)] text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            ...
            {
              title: "Pool Decks",
              img: "https://images.unsplash.com/photo-1575429198097-0dcf0da09de0?auto=format&fit=crop&w=800&q=80",
            },
            {
              title: "Steps & Caps",
              img: "https://images.unsplash.com/photo-1567930015852-551e32e6c4f4?auto=format&fit=crop&w=800&q=80",
            },
          ].map((s, i) => (
            <div
              key={i}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
          ...
          <div className="lg:col-span-2 grid grid-rows-2 gap-4">
            {[
              ...
              <div
                key={i}
                className="border border-white/5 relative group cursor-pointer overflow-hidden text-white flex items-end p-6 min-h-32"
              >
                <img
                  src={t.img}
                  alt={t.title}
