      ...
      <div className="relative z-10 flex flex-col h-full w-full max-w-7xl mx-auto px-6 sm:px-12 md:px-20">
        ...
        <div className="flex-1 flex flex-col justify-center">
          ...
          <motion.a
            ...
            className="inline-flex items-center gap-3 mb-8 px-5 py-3 border border-[#c9a449]/60 bg-[#c9a449]/10 hover:bg-[#c9a449]/20 transition-colors duration-200 max-w-fit"
          >
            <span className="w-7 h-7 rounded-full bg-[#c9a449]/20 flex items-center justify-center flex-shrink-0">
              <Phone size={13} className="text-[#c9a449]" />
            </span>
            <span className="text-[13px] sm:text-[14px] font-semibold tracking-[0.08em] uppercase text-[#c9a449]">
              For faster assistance — call us directly
            </span>
            <ArrowRight size={13} className="text-[#c9a449] opacity-70" />
          </motion.a>
