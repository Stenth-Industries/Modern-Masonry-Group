...
export default function UnderConstruction({ navigate }) {
  return (
    <div className="min-h-screen relative font-sans text-white flex flex-col items-center">
      ...
      <div className="relative z-10 mt-20 sm:mt-32 mb-8 mx-auto w-full max-w-4xl border border-[#c9a449]/40 flex flex-col px-5 sm:px-14 md:px-20 py-10 sm:py-16 [mask-image:radial-gradient(ellipse_at_center,black_55%,transparent_90%)]">
